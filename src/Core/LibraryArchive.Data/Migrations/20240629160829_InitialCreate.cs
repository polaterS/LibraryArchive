    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookShareId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NoteId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookShares", x => x.BookShareId);
                    table.ForeignKey(
                        name: "FK_BookShares_AspNetUsers_SharedWithUserId",
                        column: x => x.SharedWithUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookShares_Notes_NoteId",
                        column: x => x.NoteId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoteShare", x => x.NoteShareId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookShares_NoteId",
                table: "BookShares",
                column: "NoteId");

            migrationBuilder.CreateIndex(
                name: "IX_BookShares_SharedWithUserId",
                table: "BookShares",
